...
NitServer 教学 **Minecraft** 服务端系列

本教学服务端主要面向开服萌新或朋友联机使用

此服务端所有内容均基于 [**NitWikit**](https://nitwikit.8aka.org)

<div align="center">
  <div>
    <img src="img.png" alt="Yizhan" />
  </div>
  <b>
    NitWikit
  </b>
...
1. 从 github 上克隆本项目 `git clone https://github.com/virgil698/vanilla-survival.git`

2. 配置好 Java 环境，配置 MySQL 连接(如果有本项目需要 MySQL)
